      ...
      {isLoading && (
        ...
        >
          ...
          <motion.div
            ...
            style={{ position: 'absolute', width: '150px', height: '150px', border: '1px solid rgba(255,255,255,0.4)', borderRadius: '50%' }}
          />
          <motion.div
            animate={{ scale: [1, 2.5, 4], opacity: [0.3, 0.05, 0] }}
            transition={{ duration: 3, ease: "easeOut", repeat: Infinity, delay: 1 }}
            style={{ position: 'absolute', width: '150px', height: '150px', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '50%' }}
          />
          <motion.div
            animate={{ scale: [1, 3, 5], opacity: [0.1, 0, 0] }}
            transition={{ duration: 3, ease: "easeOut", repeat: Infinity, delay: 2 }}
            style={{ position: 'absolute', width: '150px', height: '150px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '50%' }}
          />
